...
export const getGetRetroFundingRoundBallotsResponseRound4BallotMock = (
...
export const getGetRetroFundingRoundBallotsResponseMock = (
  overrideResponse: Partial<GetRetroFundingRoundBallots200> = {},
): GetRetroFundingRoundBallots200 => ({
  ballots: faker.helpers.arrayElement([
    Array.from(
      { length: faker.number.int({ min: 1, max: 10 }) },
      (_, i) => i + 1,
    ).map(() =>
      faker.helpers.arrayElement([
        { ...getGetRetroFundingRoundBallotsResponseRound4BallotMock() },
      ]),
    ),
    undefined,
  ]),
...
export const getGetSpecMockHandler = (
  ...
  return http.get("*/spec", async (info) => {
    await delay(1000);
...
export const getGetNonceMockHandler = (
  ...
  return http.get("*/auth/nonce", async (info) => {
    await delay(1000);
...
export const getGetRetroFundingRoundBallotsMockHandler = (
  overrideResponse?:
    | GetRetroFundingRoundBallots200
    | ((
        info: Parameters<Parameters<typeof http.get>[1]>[0],
      ) =>
        | Promise<GetRetroFundingRoundBallots200>
        | GetRetroFundingRoundBallots200),
) => {
  return http.get("*/retrofunding/rounds/:roundId/ballots", async (info) => {
    await delay(1000);
      ...
      JSON.stringify(
        overrideResponse !== undefined
          ? typeof overrideResponse === "function"
            ? await overrideResponse(info)
            : overrideResponse
          : getGetRetroFundingRoundBallotsResponseMock(),
      ),
      { status: 200, headers: { "Content-Type": "application/json" } },
    );
  });
...
export const getAgoraSOPAPIBetaMock = () => [
  ...
  getGetRetroFundingRoundBallotsMockHandler(),
